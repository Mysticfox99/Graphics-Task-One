...
public:
	...
	void loadSkyBox()
	{
		sbTextures[0].load("..//..//Assets//Textures//SkyBox//front.png");
		sbTextures[1].load("..//..//Assets//Textures//SkyBox//back.png");
		sbTextures[2].load("..//..//Assets//Textures//SkyBox//left.png");
		sbTextures[3].load("..//..//Assets//Textures//SkyBox//right.png");
		sbTextures[4].load("..//..//Assets//Textures//SkyBox//top.png");
		sbTextures[5].load("..//..//Assets//Textures//SkyBox//bottom.png");
